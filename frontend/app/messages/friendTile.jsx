    ...
    function handleAddFriendClick() {
        ...
        const sendFriendRequest = async () => {
            try {
                ...
                console.log(id);
                const response = await axios.post(
                    `${SERVERLOCATION}/api/users/friends/request/${id}`,
                    null,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
    ...
    const handleAcceptFriendRequest = () => {
        ...
        const acceptFriendRequest = async () => {
            try {
                ...
                console.log(token);
                const response = await axios.post(
                    `${SERVERLOCATION}/api/users/friends/${friendData.id}`,
                    null,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
        ...
        const declineFriendRequest = async () => {
            try {
                ...
                const response = await axios.delete(
                    `${SERVERLOCATION}/api/users/friends/request/${friendData.id}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
        ...
        if (friendData.listType === "pending") {
            ...
            return (
                <>
                    ...
                    >
                        <PersonAddIcon />{" "}
                        {/* Use the PersonAddIcon for "add friend" */}
                    </IconButton>
                </>
            );
        } else {

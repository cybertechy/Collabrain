...
export default function Register()
{
	...
	return (
		...
		<div className="bg-secondary flex flex-col justify-center items-center px-16 py-10 rounded-2xl">
			<p className=" text-black font-poppins mb-2 ">You have received an OTP in your email address!</p>
			<br />
            <p className=" text-black font-poppins mb-2 italic">Enter it in the input below!</p>
			<form onSubmit={()=>{}} style={{ textAlign: "center" }}>
        <InputField placeholder="OTP" />
        <br />
	
        <Button text="Confirm" color= "primary" onClick={()=>{router.push('/dashboard');}} />
        <hr className="border-t-1 border-solid border-gray-400 mb-5"></hr>
        
      </form>
        <a className='font-poppins text-primary text-sm italic'>Resend OTP</a>

...
const toggleTeamSettingsOverlay = () => {
    setShowTeamSettingsOverlay(!showTeamSettingsOverlay); // Toggle the state
};
const handleCloseTeamSettings = () => {
    setShowTeamSettingsOverlay(false);
};

const toggleinviteUsersOverlay = () => {
    setShowinviteUsersOverlay(!showinviteUsersOverlay); // Toggle the state
};
...
const buttonStyles = { border:1, borderColor : "#30475E" , color : "#30475E",  '&:hover': {

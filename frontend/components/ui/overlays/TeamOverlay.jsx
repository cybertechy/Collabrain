...
const CreateJoinTeamScreen = ({ switchToCreateTeam, switchToJoinTeam , toggleModal}) => {
  return (
      <div className='w-screen h-screen flex items-center justify-center'>
        <div className='w-full h-4/5 xs:h-3/5 xs:w-3/4 shadow-lg bg-basicallylight rounded-md flex flex-col md:w-3/5 lg:w-2/3 2xl:w-1/3'> {/* Make sure this is a flex container with column direction */}

...
<button className="h-16 w-16 lg:w-32 lg:h-32 sm:h-auto sm:w-auto"><img src={require("./blackBG.png")} alt="image1" /></button>
<button className="h-16 w-16 lg:w-32 lg:h-32 sm:h-auto sm:w-auto"><img src={require("./purpleBG.png")} alt="image2" /></button>
</div>
<div className="mb-4">

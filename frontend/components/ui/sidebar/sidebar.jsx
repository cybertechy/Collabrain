                    ...
                    <div className="flex items-center justify-center">
                        {isOpen ? (
                            <div className = "flex items-center justify-center transition-all duration-1000 ease-in-out">
                                <img className="transition-all duration-500 ease-in-out w-12 mb-2" src="/assets/images/logo_whitebackground.png" alt="Collabrain Logo" />
                                <p className="text-xl font-poppins transition-all duration-1000 ease-in-out">Collabrain</p>
                                <CloseIcon className="text-lg ml-16 text-black transition-all duration-1000 ease-in-out cursor-pointer" onClick={toggleSidebar} />
                            </div>
                        ) : (
                            <MenuIcon className="h-6 w-6 mb-2 text-lg transition-all duration-500 ease-in-out cursor-pointer" onClick={toggleSidebar} />
                        )}
                    </div>
                </div>

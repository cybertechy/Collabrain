    ...
    return (
        ...
        >
            <Link href={href}>
                ...
                >
                    {Icon && (
                        <Icon fontSize="large" className={`mr-2 transition-all duration-500 ease-in-out ${itemClasses}`} />
                    )}
                    <span
                    ...
                    {showChevron && (
                        <ChevronRightIcon
                            fontSize="large"
                            className={`ml-auto transition-all duration-500 ease-in-out ${itemClasses}`}
                        />
                    )}
                </div>
            </Link>
